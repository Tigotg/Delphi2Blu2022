...
begin
  case TTipoRepeticao(rdgCondicao.ItemIndex) of
    tprFor: //FOR
    begin
      //Nesse modelo vc chama direto a função(Método)
      ShowMessage('O Resultado da soma dos valores pares é: ' + IntToStr(Self.ValidaNumPar));
    end;
    tprWhile: //WHILE
    begin
      //Nesse modelo vc chama direto a função(Método)
    ...
    tprRepeat: //REPEAT
    begin
      //Nesse modelo vc cria a varial e inicializa ela recebendo a funcão (Método)

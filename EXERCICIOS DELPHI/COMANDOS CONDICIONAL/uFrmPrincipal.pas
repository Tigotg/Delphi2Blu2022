...
begin
  case TNivel(rdgNivel.ItemIndex) of
    ...
    nJunior: //Junior
    begin
      xNivel := ('Eu ' + edtvisor.text + ' sou do nível Júnior');
    end;
    nPleno: //Pleno
    begin
      xNivel := ('Eu ' + edtvisor.text + ' sou do nível Pleno');
    end;
    nSenior: //Sênior
    begin
      xNivel := ('Eu ' + edtvisor.text + ' sou do nível Sênior');
    end;
    else
    begin  //Sem Definição
      xNivel := ('Eu ' + edtvisor.text + ' desempregado, sem Nível');
    end;
  end;
  ShowMessage(xNivel);
end;

...
begin
  lblResultado.Caption := ('Resultado Soma é: ' + IntToStr(OperacaoSoma) + #13#10 +
                           'Resultado da Subtração é: ' + FloatToStr(OperacaoSubtracao) + #13#10 +
                           'Resultadoda Multiplicação é: ' +  FloatToStr(OperacaoMutiplicacao) + #13#10 +
                           'Resultado da Divisão é: ' + FloatToStr(OperacaoDivisao));
end;

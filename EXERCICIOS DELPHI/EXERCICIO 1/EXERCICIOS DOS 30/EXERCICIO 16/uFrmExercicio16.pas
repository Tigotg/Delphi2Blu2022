...
begin
  ...
  if xMedia >= 7 then
    ShowMessage('Parabéns ' + xNomeAluno + ' sua média foi: ' +
                FormatFloat('0.00', xMedia) + ' Você Foi Aprovado');
    if xMedia <= 5 then
      ShowMessage(xNomeAluno + ' sua média foi: ' + FormatFloat('0.00', xMedia) +
...
{16. Escreva um algoritmo que leia o nome e as três notas obtidas por um aluno durante o

...
var
 ...
 begin
  ...
  begin
    ValidaNum[I] := StrToInt(inputbox('INFORMAR','Digite um número',''));

    if (ValidaNum[I] >= 10) and (ValidaNum[I] <= 150) then
        inc(xTotal);
  end;
    ShowMessage('A quantidade de números que estão no intervalo entre 10 e 150 é: ' +
                xTotal.ToString + ' números.');
end;

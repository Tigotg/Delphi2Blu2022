...
begin
  ...
  if xNum > 80 then
    ShowMessage('O número ' + xNum.ToString + ' é maior que ' + xVal1.ToString)
  else if xNum < 25 then
    ShowMessage('O número ' + xNum.ToString + ' é menor que ' + xVal2.ToString)
  else if xNum = 40 then
    ShowMessage('O número ' + xNum.ToString + ' é igual a ' + xVal3.ToString)
  else
    ShowMessage('O Número informado não se enquadra na validação');
end;
